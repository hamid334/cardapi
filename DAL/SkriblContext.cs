namespace DAL
{
    ...
    public partial class SkriblContext : DbContext
    {
        public SkriblContext()
            : base("name=SkribleContextQA")
        {
            //Database.SetInitializer(new MigrateDatabaseToLatestVersion<SkriblContext, DAL.Migrations.Configuration>());
            Database.SetInitializer<SkriblContext>(null);
